...
create_lib UART -technology $tech_file -ref_libs $reference_lib
...
read_verilog  /home/ICer/Baraka/uart_8bit/Syn/uart_netlist.v 

source /home/ICer/Baraka/uart_8bit/Syn/cons/cons.sdc
...
initialize_floorplan -core_utilization 0.3 -core_offset {5.016  6.08} 

place_pins -port [get_ports *]
#set_block_pin_constraints -sides {2} -allowed_layers {M2}
#set_individual_pin_constraints -sides {2} -allowed_layers [get_layers {M2 M3}] 
...
source /home/ICer/Baraka/uart_8bit/pnr/mmmc.tcl
...
write_verilog uart.v

write_sdc -output uart.sdc
write_sdc -output uart.tcl
